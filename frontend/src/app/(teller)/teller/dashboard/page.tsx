  ...
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-sm">
        ...
        <h1 className="text-2xl font-bold text-slate-900 font-serif">Teller Overview</h1>
        <p className="text-sm text-slate-500 mt-1 max-w-2xl">
          Clean portal shell workspace for daily deposits, withdrawals, and member transactions.
        </p>
