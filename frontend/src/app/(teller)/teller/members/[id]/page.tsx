...
interface TellerMemberDetailPageProps {
  params: Promise<{ id: string }>;
}

export default function TellerMemberDetailPage({ params }: TellerMemberDetailPageProps) {
  const { id } = use(params);
        ...
        {isLoading ? (
          ...
          isEditing ? (
            ...
            <MemberProfileView
              ...
              onBack={() => router.push("/teller/members")}
            />
          )
        ) : (
          <div className="text-center py-12 text-slate-400 text-sm font-medium">
