    ...
    <div className="space-y-6">
      <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-sm">
        <div className="flex items-center gap-3 mb-3">
          ...
          <span className="text-xs text-slate-400 font-mono font-semibold uppercase tracking-wider">Tenant Admin Portal</span>
        </div>
        <h1 className="text-2xl font-bold text-slate-900 font-serif">Tenant Admin Overview</h1>
        <p className="text-sm text-slate-500 mt-1 max-w-2xl">
          Clean portal shell workspace for SACCO branch management, member oversight, and local operations.
        </p>
