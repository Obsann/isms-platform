...
const en: LeafDict = {
  ...
  dash: {
    ...
    memberDesc:
      'Live balances and loan counts, plus mocked mobile money that never reports a false success.',
    ...
    memberMomoDesc:
      'Mock Telebirr, M-PESA, and CBE Birr requests. They stay pending confirmation and never post as a success.',
...
const am: LeafDict = {
  ...
  dash: {
    ...
    memberDesc: 'የቀጥታ ቀሪ ሒሳብና የብድር ብዛት፣ እንዲሁም ፈጽሞ እንደተሳካ የማይዘገብ የተመሰለ የሞባይል ገንዘብ።',
    ...
    memberMomoDesc: 'የተመሰሉ የቴሌብር፣ M-PESA እና CBE ብር ጥያቄዎች። በማረጋገጫ ይቆያሉ፤ እንደተሳካ አይመዘገቡም።',
