...
export default function MemberManagementView({ portalType }: MemberManagementViewProps) {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-5 pb-12">
      ...
      {/* Dev mode notice */}
      {isDevMode && (
        <div className="px-4 py-2.5 bg-amber-500/10 border border-amber-500/25 rounded-xl text-amber-600 dark:text-amber-400 text-xs flex items-center gap-2 shadow-sm">
