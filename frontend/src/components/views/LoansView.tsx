...
export default function LoansView() {
  ...
  const columns: Column<LoanRecord>[] = [
    ...
    },
    {
      ...
      cell: (l) => <CurrencyDisplay value={l.requestedAmount} currency="ETB" size="sm" />,
    },
    {
    ...
    },
    {
      ...
      cell: (l) => <span className="text-xs font-medium text-slate-700 dark:text-slate-300">{l.termMonths} mos</span>,
    },
    {
      header: 'Status',
      accessorKey: 'status',
